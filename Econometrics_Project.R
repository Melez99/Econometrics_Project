...
plot(ln_GDP_plot,
     ...
     ylab = "ln_GDP",
     xlab = "Year",
     main = "U.K. Yearly Real GDP Growth")
...
plot(Year,
     ...
     xlab = "Year",
     main = "U.K. Average Hourly Wage for Males and Females")
lines(Year,
      ln_AHW_F,
      type="l",
      col = 2)
...
plot(GenderwageGap_plot,
     ...
     ylab = "GPG",
     xlab = "Year",
     main = "U.K. Relative Gender Wage Gap")
...
plot(Year,
     ...
     ylab = "Average Hours",
     xlab = "Year",
     main = "U.K. Average employment rate by gender")
lines(Year,
      E_F,
      type="l",
      col = "red")
